const CACHE='not28-v10';
const ASSETS=['./','./index.html','./styles.css?v=10','./app.js?v=10','./cloud.js?v=10','./firebase-config.js?v=10','./manifest-v10.webmanifest','./assets/apple-touch-icon-v10.png','./assets/icon-v10-192.png','./assets/icon-v10-512.png'];
